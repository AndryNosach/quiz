...
-- -----------------------------------------------------
-- Table `quiz-project`.`quiestions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quiz-project`.`quiestions` ;

CREATE TABLE IF NOT EXISTS `quiz-project`.`quiestions` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `quiz-project`.`answers` (
  ...
  PRIMARY KEY (`id`, `quiestion_id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_answers_quiestions1_idx` (`quiestion_id` ASC),
  CONSTRAINT `fk_answers_quiestions1`
    FOREIGN KEY (`quiestion_id`)
    REFERENCES `quiz-project`.`quiestions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
